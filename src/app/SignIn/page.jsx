        ...
        <>
            <main className={`${merriweather.className} ${changePass ? "blur-xl" : "blur-none"} w-full h-[100vh] flex flex-wrap md:flex-nowrap justify-center items-center relative z-10`}>
                ...
                <div className="w-full md:w-1/2 h-full p-5 md:p-14 leading-relaxed xl:leading-loose">
                    ...
                    <h3 className="capitalize text-gray-500 text-sm md:text-xs lg:text-base py-2 lg:py-5">Don't have an account? <button className="text-[#1e87f0]"><Link href='/'>Sign Up.</Link></button></h3>
                    ...
                    <p className='text-gray-500 w-full xl:w-2/3 text-sm xl:text-xs leading-6 tracking-widest lg:tracking-normal'>Welcome back to your favorite admin panel.</p>
                </div>
            </main>
            {changePass &&
                (
                    <section className="top-[50%] left-[50%] absolute translate-x-[-50%] translate-y-[-50%] bg-white border z-30 flex flex-wrap justify-center pt-20 px-10 rounded-[2rem]">
                        ...
                        <h3 className="capitalize text-gray-500 text-sm md:text-xs lg:text-base py-2 lg:py-5 w-full text-center">Don't have an account? <button className="text-[#1e87f0]"><Link href='/'>Sign Up.</Link></button></h3>
                    </section>
                )}
        </>
    )
